...
var notificarEncuesta = function (params, callback) {
    ...
    html += ' <h1>Estimado(a) ' + params.usuario + '.</h1> <p class="lead"> Por parte de la Junta de Vecinos Jardín La Dehesa le hacemos llegar una encuesta que espero nos pueda responder Para poder acceder a la encuesta por favor dirigase <a href="' + params.url + '">Aquí</a> para contestar. </p> </td> </tr> </table> </div> </td> <td></td> </tr> </table> </body></html>';
